...
<head>
  ...
  <style>
    ...
    .footer p { color:#5a7a96; font-size:13px; margin:0; }
    .footer a { color:#5a7a96; }
  </style>
</head>
<body>
  <div class="wrapper">
    <div class="card">
      ...
      <p style="color:#5a7a96; font-size:14px;">Questions? Just reply to this email — we read every one.<br>
      — The SmarterQuit Team</p>
    </div>
    <div class="footer">
